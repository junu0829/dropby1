...
<View style={styles.containerTop}>
    ...
    <TouchableOpacity><SvgXml xml={edit} width={6} height={20} style={styles.edit}></SvgXml></TouchableOpacity>
    </View>
</View>
...
<View style={styles.contentContainer}>
    <SvgXml xml={dropIcon} width={47} height={69} style={styles.dropIcon}></SvgXml>
...
<View style={styles.pictureInput}></View>
      ...
      <View style={styles.restContainer}>
        <View style={styles.iconContainer}>
         <SvgXml xml={pictureIcon} width={19} height={21} style={styles.pictureIcon}></SvgXml>
         <Text style={styles.pictureNumber}>5</Text>
         <SvgXml xml={commentIcon} width={19} height={21} style={styles.CommentIcon}></SvgXml>
         <Text style={styles.commentNumber}>3</Text>
         <SvgXml xml={heartIcon} width={19} height={21} style={styles.HeartIcon}></SvgXml>
         <Text style={styles.heartNumber}>2</Text>
        </View>
        <TouchableOpacity><SvgXml xml={LikeButton} width={85} height={29} style={styles.LikeButton}></SvgXml></TouchableOpacity>
      </View>
...
<View style={styles.commentContainer}>
    ...
    <View style={styles.comment1Container}>
       ...
       <TouchableOpacity><Text style={styles.reply}>답글달기</Text></TouchableOpacity>
               </View>
           </View>

        <TouchableOpacity><SvgXml xml={emptyHeart} width={19} height={21} style={styles.emptyHeart}></SvgXml></TouchableOpacity>
    ...
    <View style={styles.comment2Container}>
      <Text style={styles.user2}>드로퍼2</Text>
         ...
         <Text style={styles.commet2}>요즘 진짜 캠퍼스 투어하기 딱인 날씨ㄹㅇ...</Text>
     ...
     <View style={styles.comment3Container}>
      <Text style={styles.user3}>드로퍼3</Text>
         ...
         <TouchableOpacity><Text style={styles.showReply}>답글 1개 보기</Text></TouchableOpacity>
                 </View>
             </View>
    ...
    <View style={styles.commentButton}>
        <TouchableOpacity><Text style={styles.enterComment}>댓글 입력하기...</Text></TouchableOpacity>
        <TouchableOpacity><SvgXml xml={sendingAirplane} width={35} height={35} style={styles.sendingAirplane}></SvgXml></TouchableOpacity>
    </View>
